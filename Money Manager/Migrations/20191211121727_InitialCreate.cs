        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssetsAssetId = table.Column<int>(nullable: true),
                    TransactionsTransactionId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Users", x => x.UserId);
                    table.ForeignKey(
                        name: "FK_Users_Assets_AssetsAssetId",
                        column: x => x.AssetsAssetId,
                        principalTable: "Assets",
                        principalColumn: "AssetId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Users_Transactions_TransactionsTransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_AssetsAssetId",
                table: "Users",
                column: "AssetsAssetId");

            migrationBuilder.CreateIndex(
                name: "IX_Users_TransactionsTransactionId",
                table: "Users",
